    ...
    <div className="w-81.75 h-107.25 mb-50 flex flex-col justify-center items-center ">
      ...
      <div className=" flex flex-col justify-center items-center bg-(--semi-dark-navy) shadow-[inset_0px_-8px_0px_#10212a] w-full rounded-[15px]">
        ...
        <div className=" flex justify-center items-center bg-(--dark-navy) w-69.75 h-18 rounded-[10px]">
          <div className="rounded-[10px] w-33 h-13.5">
            <svg
              className="fill-(--silver) scale-50 mx-auto -m-1"
              width="64"
              height="64"
          ...
          <div className="bg-(--silver) rounded-[10px] w-33 h-13.5 mx-auto">
            <svg
              className="fill-(--dark-navy) scale-50 mx-auto -m-1"
              width="64"
              height="64"
              xmlns="http://www.w3.org/2000/svg"
            >
      ...
      <div className="buttons text-(--dark-navy) flex justify-center flex-col gap-4 w-full font-bold text-center mt-8 ">
        <div className=" bg-(--light-yellow) shadow-[inset_0px_-8px_0px_#cc8b13] h-14 rounded-[15px] px-2.5 py-3.5">
          New Game (VS CPU)
        </div>
        <div className=" bg-(--light-blue) shadow-[inset_0px_-8px_0px_#118c87] h-14 rounded-[15px] px-2.5 py-3.5">
          New Game (VS PLAYER)
        </div>
      </div>
    </div>
